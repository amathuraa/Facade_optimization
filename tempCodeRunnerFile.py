...
def clean_csv(filename,length=0):
...
def rotate_triangles(rotation_list, translation_list, triangles):
    ...
    rotation_matrices = rotation_list.reshape(n, n, 3, 3)
    ...
    translation_matrix = translation_list.reshape(n,n,1,3)
...
def main():
    triangle_list = clean_csv(FILE_NAME,length=10)
